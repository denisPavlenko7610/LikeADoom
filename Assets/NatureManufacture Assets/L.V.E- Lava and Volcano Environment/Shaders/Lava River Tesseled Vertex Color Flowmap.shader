Shader "NatureManufacture Shaders/Lava/Lava River Tesseled Vertex Color Flowmap"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 temp_output_1213_0 = ( uv0_MediumLavaAlbedo_SM + ( appendResult1208 * temp_output_1139_0 ) );
			float2 MediumFlowUV11226 = temp_output_1213_0;
			half4 tex2DNode852 = tex2Dlod( _MediumLavaMT_AO_H_EM, half4( MediumFlowUV11226, 0, 1.0) );
			float2 MediumFlowUV21227 = ( uv0_MediumLavaAlbedo_SM + ( appendResult1208 * temp_output_1137_0 ) );
			half4 tex2DNode860 = tex2Dlod( _MediumLavaMT_AO_H_EM, half4( MediumFlowUV21227, 0, 1.0) );
			float clampResult1223 = clamp( pow( abs( ( ( temp_output_1139_0 + -0.5 ) * 2.0 ) ) , ( tex2Dlod( _MediumLavaMT_AO_H_EM, half4( temp_output_1213_0, 0, 0.0) ).b * 7.0 ) ) , 0.0 , 1.0 );
			...
			float2 temp_output_1243_0 = ( uv0_HotLavaAlbedo_SM + ( appendResult1238 * temp_output_1139_0 ) );
			float2 HotFlowUV11257 = temp_output_1243_0;
			half4 tex2DNode861 = tex2Dlod( _HotLavaMT_AO_H_EM, half4( HotFlowUV11257, 0, 1.0) );
			float2 HotFlowUV21258 = ( uv0_HotLavaAlbedo_SM + ( appendResult1238 * temp_output_1137_0 ) );
			half4 tex2DNode854 = tex2Dlod( _HotLavaMT_AO_H_EM, half4( HotFlowUV21258, 0, 1.0) );
			float clampResult1255 = clamp( pow( abs( ( ( temp_output_1139_0 + -0.5 ) * 2.0 ) ) , ( tex2Dlod( _HotLavaMT_AO_H_EM, half4( temp_output_1243_0, 0, 0.0) ).b * 7.0 ) ) , 0.0 , 1.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 MediumFlowUV11226 = temp_output_1213_0;
			float2 MediumFlowUV21227 = ( uv0_MediumLavaAlbedo_SM + ( appendResult1208 * temp_output_1137_0 ) );
			float clampResult1223 = clamp( pow( abs( ( ( temp_output_1139_0 + -0.5 ) * 2.0 ) ) , ( tex2D( _MediumLavaMT_AO_H_EM, temp_output_1213_0 ).b * 7.0 ) ) , 0.0 , 1.0 );
			float MediumFlowHeightBase1228 = clampResult1223;
			float3 lerpResult1279 = lerp( UnpackScaleNormal( tex2D( _MediumLavaNormal, MediumFlowUV11226 ), _MediumLavaNormalScale ) , UnpackScaleNormal( tex2D( _MediumLavaNormal, MediumFlowUV21227 ), _MediumLavaNormalScale ) , MediumFlowHeightBase1228);
			...
			float2 HotFlowUV11257 = temp_output_1243_0;
			float2 HotFlowUV21258 = ( uv0_HotLavaAlbedo_SM + ( appendResult1238 * temp_output_1137_0 ) );
			float clampResult1255 = clamp( pow( abs( ( ( temp_output_1139_0 + -0.5 ) * 2.0 ) ) , ( tex2D( _HotLavaMT_AO_H_EM, temp_output_1243_0 ).b * 7.0 ) ) , 0.0 , 1.0 );
			float HotFlowHeightBase1259 = clampResult1255;
			float3 lerpResult1280 = lerp( UnpackScaleNormal( tex2D( _HotLavaNormal, HotFlowUV11257 ), _HotLavaNormalScale ) , UnpackScaleNormal( tex2D( _HotLavaNormal, HotFlowUV21258 ), _HotLavaNormalScale ) , HotFlowHeightBase1259);
			half4 tex2DNode852 = tex2D( _MediumLavaMT_AO_H_EM, MediumFlowUV11226 );
			half4 tex2DNode860 = tex2D( _MediumLavaMT_AO_H_EM, MediumFlowUV21227 );
			float4 lerpResult1291 = lerp( tex2DNode852 , tex2DNode860 , MediumFlowHeightBase1228);
			float4 break884 = lerpResult1291;
			float temp_output_942_0 = ( 1.0 - break884.b );
			float clampResult507 = clamp( ase_worldNormal.y , 0.0 , 1.0 );
			...
			half4 tex2DNode861 = tex2D( _HotLavaMT_AO_H_EM, HotFlowUV11257 );
			half4 tex2DNode854 = tex2D( _HotLavaMT_AO_H_EM, HotFlowUV21258 );
			float4 lerpResult1292 = lerp( tex2DNode861 , tex2DNode854 , HotFlowHeightBase1259);
			float4 break893 = lerpResult1292;
			float HeightMask998 = saturate(pow(((( 1.0 - break893.b )*break770.b)*4)+(break770.b*2),_VCHotLavaHeightBlendStrenght));
			float temp_output_1000_0 = ( break770.b * HeightMask998 );
			...
			float4 lerpResult1231 = lerp( tex2D( _MediumLavaAlbedo_SM, MediumFlowUV11226 ) , tex2D( _MediumLavaAlbedo_SM, MediumFlowUV21227 ) , MediumFlowHeightBase1228);
			...
			float4 lerpResult1256 = lerp( tex2D( _HotLavaAlbedo_SM, HotFlowUV11257 ) , tex2D( _HotLavaAlbedo_SM, HotFlowUV21258 ) , HotFlowHeightBase1259);

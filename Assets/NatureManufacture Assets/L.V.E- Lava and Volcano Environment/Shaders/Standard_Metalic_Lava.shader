Shader "NatureManufacture Shaders/Lava/Standard Metalic Lava"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 clampResult537 = clamp( temp_output_534_0 , float4( 0,0,0,0 ) , temp_output_534_0 );
			...
			float4 clampResult539 = clamp( temp_output_521_0 , float4( 0,0,0,0 ) , temp_output_521_0 );
			o.Emission = ( clampResult537 + clampResult539 ).rgb;

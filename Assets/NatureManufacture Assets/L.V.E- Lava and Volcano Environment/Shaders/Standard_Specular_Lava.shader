Shader "NatureManufacture Shaders/Lava/Standard Specular Lava"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 normalizeResult202 = normalize( BlendNormals( tex2DNode4 , appendResult10_g1 ) );
			...
			half4 temp_cast_0 = (( _DetailAlbedoPower * tex2DNode205.r )).xxxx;
			half4 blendOpSrc189 = temp_output_44_0;
			half4 blendOpDest189 = temp_cast_0;
			...
			float4 clampResult268 = clamp( temp_output_252_0 , float4( 0,0,0,0 ) , temp_output_252_0 );
			...
			float4 clampResult267 = clamp( temp_output_245_0 , float4( 0,0,0,0 ) , temp_output_245_0 );
			o.Emission = ( clampResult268 + clampResult267 ).rgb;

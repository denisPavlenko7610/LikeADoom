Shader "NatureManufacture Shaders/Lava/Lava River Tesseled Vertex Color Cheap"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 panner611 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _ColdLavaMainSpeed :  appendResult705 ) + v.texcoord.xy);
			...
			float4 break884 = tex2Dlod( _ColdLavaMT_AO_H_EM, half4( SmallCascadeSpeedValueMain600, 0, 1.0) );
			...
			float4 break893 = tex2Dlod( _ColdLavaMT_AO_H_EM, half4( BigCascadeSpeedMain608, 0, 1.0) );
